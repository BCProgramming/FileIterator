...
namespace System.IO.Shell
{
    ...
    public class ShellContextMenu
    {
        ...
        #region Events
        public class QueryMenuEventArgs : EventArgs
        {
            private IntPtr _hMenu;
            private ShellContextMenu _scm;
            public IntPtr hMenu { get { return _hMenu; } private set { _hMenu = value; } }
            public ShellContextMenu ShellMenu { get { return _scm; } private set { _scm = value; } }
            internal QueryMenuEventArgs(ShellContextMenu scm,IntPtr phMenu)
            {
                ShellMenu = scm;
                hMenu = phMenu;
        ...
        public event EventHandler<QueryMenuEventArgs> BeforeQueryMenu;
        public event EventHandler<QueryMenuEventArgs> AfterQueryMenu;
        public void RaiseBeforeQueryMenu(IntPtr hMenu)
        {
            //
            var copied = BeforeQueryMenu;
            if (copied != null) copied(this, new QueryMenuEventArgs(this,hMenu));

        }
        public void RaiseAfterQueryMenu(IntPtr hMenu)
        {
            var copied = AfterQueryMenu;
            if (copied != null) copied(this, new QueryMenuEventArgs(this,hMenu));
        }
        #endregion
        ...
        #endregion
        //IContextMenu, IContextMenu2, and IContextMenu3 interface declarations.
        #region IContextMenu
        [ComImport()]
        [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
